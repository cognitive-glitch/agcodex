...
mod tests {
    ...
    fn test_edit_line() {
        ...
        let result =
            EditTool::edit_line(temp_file.path().to_str().unwrap(), 2, "modified line 2").unwrap();
    ...
    fn test_edit_text_ambiguous() {
        ...
        let result = EditTool::edit_text(temp_file.path().to_str().unwrap(), "hello", "hi");
    ...
    fn test_find_matches() {
        ...
        let matches = EditTool::find_matches(temp_file.path().to_str().unwrap(), "hello").unwrap();
